    ...
    <div>
      ...
      <div className="bg-white px-20 py-20">
        ...
        <div className="flex justify-between gap-8">
          ...
          <div className="bg-purple-50 rounded-xl p-8 text-center w-1/3">
            <div className="bg-purple-600 text-white w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 font-bold">1</div>
          ...
          <div className="bg-purple-50 rounded-xl p-8 text-center w-1/3">
            <div className="bg-purple-600 text-white w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 font-bold">2</div>
            <div className="text-4xl mb-4">🤖</div>
          ...
          <div className="bg-purple-50 rounded-xl p-8 text-center w-1/3">
            <div className="bg-purple-600 text-white w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 font-bold">3</div>
            <div className="text-4xl mb-4">📱</div>
